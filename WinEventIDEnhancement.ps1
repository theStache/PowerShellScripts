#Reads in CSV, selects column containing Windows Event ID information; provides a new column with the event Id details
#To utilize, change the $_.SYSTEM_EVENT_ID to whatever your CSV has the Window Event ID numbers labed as. 
#Change the import-csv/export-csv options to #desired locations.
#Use at own risk; Tyler Williams - tjwill86@gmail.com; 20180618
#
...
date;
$csv = import-csv '\\path\to\import.csv'
$csv = ($csv | Select-Object *,@{Name="Expanded_SYSTEM_EVENTID";Expression='.'}); $csv| %{$_.Expanded_SYSTEM_EVENTID = dataParser($_.SYSTEM_EVENTID)}; $csv | Export-Csv \\path\to\output.csv -NoTypeInformation
date;
